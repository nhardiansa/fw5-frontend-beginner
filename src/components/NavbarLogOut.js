...
export default class NavbarLogOut extends Component {
  ...
  render() {
    return (
      <nav className="navbar navbar-expand-lg navbar-light bg-light position-fixed top-0 w-100 py-lg-4">
        <div className="container d-flex align-items-center">
          <a className="navbar-brand" href="/">
            <img className="logo" src={carWeel} alt="vehicle-rent-logo" />
          </a>
          <button
          ...
          <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div className="navbar-nav d-flex ms-auto">
              ...
              <a className="nav-link" href="/vehicle-type.html">
                Vehicle Type
              </a>
