...
export default function Profile () {
      ...
      <>
              ...
              <div className="female gender-option">
                  <div className="radio-input d-flex align-items-center">
                    <input
                      ...
                      name="gender" onChange={genderChange}
                      id="female" />
                    <div className="checkmark me-3"></div>
        ...
        <div className="form-section mt-5 px-3">
          <form onSubmit={handleSubmit}>
            ...
            >
              ...
              <div className="birthdate mt-5 mb-5 w-100 ms-md-5">
                ...
                <input
                  ...
                  name="birthdate"
                  id="birthdate"
                  value={updateProfile.birthdate || dateFormatter(user.profile.birthdate) || ''}
            ...
            >
              <Button type='submit' className="save btn">Save Change</Button>
              <Button onClick={changePasswordHandler} className="edit-password btn">Edit Password</Button>
  ...
  return (
    <Layout>
      <main className={'profile container' + ((!user.isLoading && user.profile) ? '' : ' vh-100 d-flex justify-content-center align-items-center')}>
